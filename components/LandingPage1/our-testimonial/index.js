    ...
    const [List] = useState([
        {
            ...
            image: '../../../../static/assets/images/testimonial/01.png'
        },
        {
            name: 'Nik Jorden',
            designation: 'Designer, Qloud',
            ...
            image: '../../../../static/assets/images/testimonial/02.png'
        },
        {
            name: 'Rinks Cooper',
            designation: 'Designer, Qloud',
            desc: 'Text of the printing and typesetting industry. Lorem Ipsum has been the industry’s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled.',
            image: '../../../../static/assets/images/testimonial/03.png'
        }
    ]);
    return (
        <>
            <section className="iq-testimonial-section">
