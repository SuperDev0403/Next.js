                                ...
                                <ul className="list-type">
                                    ...
                                    <li className="type-1 iq-rela">
                                        ...
                                        <div className="d-inline-block iq-heading iq-image">
                                            <img src="../../../static/assets/images/client/c1.png" className="img-fluid" alt="client-img" />
                                            <img src="../../../static/assets/images/client/c-a5.png" className="img-fluid" alt="client-img" />
                                        </div>
                                    </li>
                                    <li className="type-1 iq-rela">
                                        <div className="d-inline-block iq-heading mt-2">
                                        ...
                                        <div className="d-inline-block  iq-heading iq-image">
                                            <img src="../../../static/assets/images/client/c4.png" className="img-fluid" alt="client-img" />
                                            <img src="../../../static/assets/images/client/c5.png" className="img-fluid" alt="client-img" />
                                        </div>
                                    </li>
                                </ul>
                            </div>
