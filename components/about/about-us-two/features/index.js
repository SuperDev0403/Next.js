...
const Index = props => {
    const [List] = useState([
        { title: 'Cloud Compute', image: '../../../../static/assets/images/fancy-box/01.png', desc: 'It is a long established fact that a reader will be distracted by the of readable content deploy at scale on the.' },
        { title: 'Block Storage', image: '../../../../static/assets/images/fancy-box/02.png', desc: 'It is a long established fact that a reader will be distracted by the of readable content deploy at scale on the.' },
        { title: 'Dedicated Cloud', image: '../../../../static/assets/images/fancy-box/03.png', desc: 'It is a long established fact that a reader will be distracted by the of readable content deploy at scale on the.' }
    ]);
    return (
        <>
