...
const Index = props => {
    ...
    const [List2] = useState([
        ...
        { title: 'Social Services', image: '../../../static/assets/images/process/03.png', desc: 'There are many variations of passages of readable content page looking' },
    ]);
    const [List3] = useState([
        { title: 'Clean Design', image: '../../../static/assets/images/process/02.png', desc: 'There are many variations of passages of readable content page looking' },
        { title: 'Creative Ideas', image: '../../../static/assets/images/process/03.png', desc: 'There are many variations of passages of readable content page looking' }
    ]);
    return (
        <>
