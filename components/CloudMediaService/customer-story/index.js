...
const Index = props => {
    const [List] = useState([
        { title: 'Dignissimos wisi cillum', image: '../../../static/assets/images/portfolio/01.png', desc: 'Print — Branding' },
        { title: 'Dignissimos wisi cillum', image: '../../../static/assets/images/portfolio/02.png', desc: 'WordPress — eCommerce' },
        { title: 'Dignissimos wisi cillum', image: '../../../static/assets/images/portfolio/03.png', desc: 'Print — Branding' },
        { title: 'Dignissimos wisi cillum', image: '../../../static/assets/images/portfolio/04.png', desc: 'WordPress — eCommerce' },
        { title: 'Dignissimos wisi cillum', image: '../../../static/assets/images/portfolio/05.png', desc: 'WordPress — eCommerce' },
        { title: 'Dignissimos wisi cillum', image: '../../../static/assets/images/portfolio/06.png', desc: 'WordPress — eCommerce' }
    ]);
    return (
        <>
