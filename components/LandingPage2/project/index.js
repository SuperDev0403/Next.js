    ...
    return (
        <>
            <section>
                ...
                <img src="../../../static/assets/images/others/shape1.png" className="img-fluid shape-right" alt="1" />
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-6 col-sm-12">
                            <img src="../../../static/assets/images/others/05.png" className="img-fluid" alt="qloud" />
                        </div>
                    </div>
                </div>
            </section>
