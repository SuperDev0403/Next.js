...
const Index = props => {
    const [List] = useState([
        { title: 'Select a service type', 'images': '../../../static/assets/images/work/01.png', 'arrow': '../../../static/assets/images/arrow/01.png', 'desc': 'It is a long established fact that a  freader will be distracted by the.' },
        { title: 'Deploy in seconds', 'images': '../../../static/assets/images/work/02.png', 'arrow': '../../../static/assets/images/arrow/01.png', 'desc': 'It is a long established fact that a  freader will be distracted by the.' },
        { title: 'Update automaticall', 'images': '../../../static/assets/images/work/03.png', 'arrow': '', 'desc': 'It is a long established fact that a  freader will be distracted by the.' }
    ]);
    return (
        <>
            <section className="iq-fancy-box-section">
                <img src="../../../static/assets/images/others/shape1.png" className="img-fluid shape-left" alt="QLOUD" />
