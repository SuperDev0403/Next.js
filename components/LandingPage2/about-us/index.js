...
const Index = props => {
    const [List1] = useState([
        { title: 'FAQ', image: '../../../static/assets/images/icon-box/07.png', link: '#' },
        { title: 'Server Status', image: '../../../static/assets/images/icon-box/08.png', link: '#' }
    ]);
    const [List2] = useState([
        { title: 'Documentation', image: '../../../static/assets/images/icon-box/09.png', link: '#' },
        { title: 'APIs', image: '../../../static/assets/images/icon-box/07.png', link: '#' }
    ]);
    return (
        <>
                            ...
                            <div className="iq-fancy-box iq-resorces  text-left active wow fadeInUp ">
                                <div className="iq-fancy-box-content">
                                    <div className="iq-img-area">
                                        <img src="../../../../static/assets/images/others/04.png" className="img-fluid" title="img1" alt="qloud" /> </div>
