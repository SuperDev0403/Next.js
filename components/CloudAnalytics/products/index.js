    ...
    const [List] = useState([
        {
            ...
            image: '../../../static/assets/images/icon-box/10.png',
            link: '/services',
        ...
        },
        {
            ...
            image: '../../../static/assets/images/icon-box/11.png',
            link: '/services',
            desc: 'It is a long established fact that a reader will be distracted by the of readable content Deploy at scale on the.'
        },
        {
            title: 'Cloud Pub/Sub',
            image: '../../../static/assets/images/icon-box/13.png',
            link: '/services',
            desc: 'It is a long established fact that a reader will be distracted by the of readable content Deploy at scale on the.'
        },
        {
            title: 'Cloud Data Transfer',
            image: '../../../static/assets/images/icon-box/12.png',
            link: '/services',
            desc: 'It is a long established fact that a reader will be distracted by the of readable content Deploy at scale on the.'
        },
        {
            title: 'Cloud Data Fusion',
            image: '../../../static/assets/images/icon-box/06.png',
            link: '/services',
            desc: 'It is a long established fact that a reader will be distracted by the of readable content Deploy at scale on the.'
        },
        {
            title: 'Cloud Composer',
            image: '../../../static/assets/images/icon-box/14.png',
            link: '/services',
            desc: 'It is a long established fact that a reader will be distracted by the of readable content Deploy at scale on the.'
        }
    ]);
