...
const Index = props => {
    ...
    const [List1] = useState([
        { title: 'Marketing', image: '../../../static/assets/images/icon-box/13.png', desc: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.' },
        { title: 'Social Services', image: '../../../static/assets/images/icon-box/03.png', desc: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.' },
    ]);
    const [List2] = useState([
        { title: 'Clean Design', image: '../../../static/assets/images/icon-box/14.png', desc: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.' },
        { title: 'Creative Ideas', image: '../../../static/assets/images/icon-box/16.png', desc: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.' },
    ]);
    return (
        <>
