...
const Index = props => {
    const [List] = useState([
        {
            title: 'Add-ons',
            image: '../../../static/assets/images/fancy-list/01.png',
        ...
        {
            title: 'Add-ons',
            image: '../../../static/assets/images/fancy-list/02.png',
            services: [{ title: 'Advance Advisory Team' }, { title: 'Professional Services' }],
            desc: ' It is a long established fact that a reader will be distracted by the.'
        },
        {
            title: 'Static Sites',
            image: '../../../static/assets/images/fancy-list/03.png',
            services: [{ title: 'Advance Advisory Team' }, { title: 'Professional Services' }],
            desc: ' It is a long established fact that a reader will be distracted by the.'
        },
        {
            title: 'Data Clips ',
            image: '../../../static/assets/images/fancy-list/04.png',
            services: [{ title: 'Advance Advisory Team' }, { title: 'Professional Services' }],
            desc: ' It is a long established fact that a reader will be distracted by the.'
        },
        {
            title: 'Data Rollback',
            image: '../../../static/assets/images/fancy-list/05.png',
            services: [{ title: 'Advance Advisory Team' }, { title: 'Professional Services' }],
            desc: ' It is a long established fact that a reader will be distracted by the.'
        },
        {
            title: 'App Metrics',
            image: '../../../static/assets/images/fancy-list/06.png',
            services: [{ title: 'Advance Advisory Team' }, { title: 'Professional Services' }],
            desc: ' It is a long established fact that a reader will be distracted by the.'
        }
    ]);
