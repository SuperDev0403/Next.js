    ...
    const [Sliders] = useState([
        {
            ...
            link: '#',
            image: '../../../static/assets/images/security/01.png'
        },
        {
            id: 'docker',
            title: 'Docker',
            desc: 'The placeholder text, beginning with the line “Lorem ipsum dolor sit amet, consectetur adipiscing elit”, looks like Latin because in its youth, centuries ago, it was Latin',
            link: '#',
            image: '../../../static/assets/images/security/02.png',
        },
        {
            id: 'kubernetes',
            title: 'Kubernetes',
            desc: 'The placeholder text, beginning with the line “Lorem ipsum dolor sit amet, consectetur adipiscing elit”, looks like Latin because in its youth, centuries ago, it was Latin',
            link: '#',
            image: '../../../static/assets/images/security/03.png'
        },
        {
            id: 'Openshift',
            ...
            desc: 'The placeholder text, beginning with the line “Lorem ipsum dolor sit amet, consectetur adipiscing elit”, looks like Latin because in its youth, centuries ago, it was Latin',
            link: '#',
            image: '../../../static/assets/images/security/04.png'
        },
        {
            id: 'AWS-2',
        ...
        },
        {
            ...
            desc: 'The placeholder text, beginning with the line “Lorem ipsum dolor sit amet, consectetur adipiscing elit”, looks like Latin because in its youth, centuries ago, it was Latin',
            link: '#',
            image: '../../../static/assets/images/security/07.png'
        }
    ]);
