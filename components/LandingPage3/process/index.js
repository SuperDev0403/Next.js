...
const Index = props => {
    const [List1] = useState([
        { title: 'Marketing', image: '../../../static/assets/images/process/01.png', desc: 'There are many variations of passages of readable content page looking' },
        { title: 'Social Services', image: '../../../static/aassets/images/process/03.png', desc: 'There are many variations of passages of readable content page looking' }
    ]);

    const [List2] = useState([
        { title: 'Clean Design', image: '../../../static/aassets/images/process/02.png', desc: 'There are many variations of passages of readable content page looking' },
        { title: 'Creative Ideas', image: '../../../static/aassets/images/process/04.png', desc: 'There are many variations of passages of readable content page looking' }
    ]);
    return (
